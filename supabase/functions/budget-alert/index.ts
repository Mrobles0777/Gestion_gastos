 ...
 *
 * Invoked from the client when a user exceeds 75% of their salary.
...
const FROM_EMAIL = 'Gestión de Gastos <noreply@tudominio.com>';
    ...
    try {
        ...
        const emailResponse = await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
                from: FROM_EMAIL,
                to: [email],
                subject: `⚠️ Alerta: superaste el 75% de tu sueldo`,
                html: `
          <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
            ...
            <p style="color: #6b7280; font-size: 14px;">
              Este correo se envía una sola vez por mes al superar el 75% del presupuesto.
            </p>
          </div>
        `,
            }),
